...
namespace CyberRPG.Camera
{
	public class DebugCamera : Spatial, ICamera
	{
		...
		public override void _Input(InputEvent @event)
		{
			...
			{
				RotateCamera(-(eventMotion.Relative.x * ROTATION_SENSTIVITY), -(eventMotion.Relative.y * ROTATION_SENSTIVITY));
			}
		}
		...
		public override void _Process(float delta)
		{
			...
			RotateCamera((rotationYaw * CONTROLLER_SENSTIVITY), -(rotationPitch * CONTROLLER_SENSTIVITY));
